...
public class ReportLostItem extends Fragment {
    DatePicker picker;
    String date;
    @Override
    ...
    public void report(LostItem item){
        ...
        LostItemTestApi demoService = new RestAdapter.Builder()
        ...
        demoService.reportlost(userIdentification.getUserid(), item, new Callback<String>() {
            @Override
